        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MinTables = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_GalleryAlbums_ServiceCategories_ServiceCategoryId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuGroups_ServiceCategories_ServiceCategoryId",
                        column: x => x.ServiceCategoryId,
                        principalTable: "ServiceCategories",
                        principalColumn: "Id");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    PricePerTray = table.Column<decimal>(type: "decimal(18,0)", nullable: false),
                    IsActive = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MenuPackages_MenuGroups_MenuGroupId",
                        column: x => x.MenuGroupId,
                        principalTable: "MenuGroups",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    QuantityTables = table.Column<int>(type: "int", nullable: true),
                    QuantityTrays = table.Column<int>(type: "int", nullable: true),
                    Note = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    EstimatedTotal = table.Column<decimal>(type: "decimal(18,0)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Leads_ServiceCategories_ServiceCategoryId",
                        column: x => x.ServiceCategoryId,
                        principalTable: "ServiceCategories",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_MenuPackageItems", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MenuPackageItems_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_MenuPackageItems_MenuPackages_MenuPackageId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    MenuPackageId = table.Column<int>(type: "int", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_LeadMenuSelections", x => x.Id);
                    table.ForeignKey(
                        name: "FK_LeadMenuSelections_Leads_LeadId",
                        column: x => x.LeadId,
                        principalTable: "Leads",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_LeadMenuSelections_MenuItems_MenuItemId",
                        column: x => x.MenuItemId,
                        principalTable: "MenuItems",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_LeadMenuSelections_MenuPackages_MenuPackageId",
                        column: x => x.MenuPackageId,
                        principalTable: "MenuPackages",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_GalleryAlbums_ServiceCategoryId",
                table: "GalleryAlbums",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_LeadMenuSelections_LeadId",
                table: "LeadMenuSelections",
                column: "LeadId");

            migrationBuilder.CreateIndex(
                name: "IX_LeadMenuSelections_MenuItemId",
                table: "LeadMenuSelections",
                column: "MenuItemId");

            migrationBuilder.CreateIndex(
                name: "IX_LeadMenuSelections_MenuPackageId",
                table: "LeadMenuSelections",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Leads_ServiceCategoryId",
                table: "Leads",
                column: "ServiceCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuGroups_ServiceCategoryId",
                table: "MenuGroups",
                column: "ServiceCategoryId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_MenuPackageItems_MenuItemId",
                table: "MenuPackageItems",
                column: "MenuItemId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuPackageItems_MenuPackageId",
                table: "MenuPackageItems",
                column: "MenuPackageId");

            migrationBuilder.CreateIndex(
                name: "IX_MenuPackages_MenuGroupId",
                table: "MenuPackages",
                column: "MenuGroupId");
